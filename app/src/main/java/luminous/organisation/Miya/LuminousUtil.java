...
public class LuminousUtil {
    ...
    public static Uri getUri(File file, Context ctx) {
        isUri = false;
    ...
    public static void getdbref(String array, String hash, Runnable received, Runnable failed, Runnable no_data) {
        DatabaseReference ref1 = FirebaseDatabase.getInstance().getReference(array).child(hash);
        try {
    ...
    public  static void copyToClipboard(Context context, String clip_data) {
        ClipboardManager clipboard = (ClipboardManager) context.getSystemService(Context.CLIPBOARD_SERVICE);
        ClipData clip = ClipData.newPlainText("label", clip_data);
